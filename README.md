...
# General remarks
The original implementation of ash2shukla looks very promising, however, I was not able to get it running on my system. Moreover, it does not support bokeh 2.4.3 and is not maintained anymore. For this repository, I took the code from ChristophNa and updated it to work with bokeh 2.4.3.
